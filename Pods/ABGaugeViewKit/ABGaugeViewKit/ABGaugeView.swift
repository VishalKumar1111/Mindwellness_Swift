...
public class ABGaugeView: UIView {
    ...
    func drawNeedleCircle() {
        ...
        let circlePath = UIBezierPath(arcCenter: CGPoint(x: bounds.width / 2, y: bounds.height / 2), radius: self.bounds.width/20, startAngle: 0.0, endAngle: CGFloat(2 * Double.pi), clockwise: true)
        // 2
